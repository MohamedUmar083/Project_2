...
<label for="trainName">Train Name:</label>
        ...
        <input type="radio" id="openStatus" name="crossingStatus" value="Open"<% if ("Open".equals(resultSet.getString("crossing_status"))) { %>checked<% } %>>
        <label for="openStatus">Open</label>

        <input type="radio" id="closedStatus" name="crossingStatus" value="Closed"<% if ("Closed".equals(resultSet.getString("crossing_status"))) { %>checked<% } %>>
